...
import com.example.alaram.data.AlarmReminderContract;
import com.example.alaram.data.AlarmReminderDbHelper;
import com.getbase.floatingactionbutton.FloatingActionButton;

public class MainReminderActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reminderListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Intent intent = new Intent(MainReminderActivity.this, AddReminderActivity.class);
